...
export class RemoveGitHubFromPlatform1613247726709 implements MigrationInterface {
    name = 'RemoveGitHubFromPlatform1613247726709'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "ticket"."supportMembers" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "ticket"."platform" IS NULL`);
        await queryRunner.query(`CREATE TYPE "ticket_platform_enum_old" AS ENUM('GitHub', 'Slack')`);
